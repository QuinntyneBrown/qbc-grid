...
| `L2-026` | `L1-009` | The grid shall emit the repaired layout exactly once for each supplied layout that normalization changes, whatever the repair changed, and shall emit nothing for one it does not change. |
